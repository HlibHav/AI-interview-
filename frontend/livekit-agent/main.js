...
export default defineAgent({
  entry: async (ctx) => {
    ...
    const voiceAgent = new voice.Agent({
      instructions: "You are a qualitative research assistant that helps with the research for a product team to help them understand user behaviour and to validate product ideas, product fit, and new potential features.",
      tools: {
        lookupWeather: llm.tool({
          description: 'Ask questions to the user to help them understand their behaviour and to validate product ideas, product fit, and new potential features.',
          parameters: {
            type: "object",
            properties: {
              location: {
                type: "string",
                description: "The question to ask the user to help them understand their behaviour and to validate product ideas, product fit, and new potential features."
              }
            }
          },
